...
from .views import Submission, Recipe, RecipeLike, SubmissionDetail, SubmissionListView, SubmissionLike

urlpatterns = [
    path('', views.RecipeList.as_view(), name='home'),
    path('submission_list', views.SubmissionListView.as_view(), name='submission_list'),
    path('submission_detail/<int:pk>', views.SubmissionDetail.as_view(), name='submission_detail'),
